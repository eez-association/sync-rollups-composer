...
use super::delivery::compute_proxy_address_on_l1;

// `extract_delivery_output_from_trigger_trace`, `find_delivery_call`,
// `MAX_SIMULATION_ITERATIONS`, and `extract_l1_to_l2_return_calls`
// moved to `super::delivery`. Re-export for internal callers.
use super::delivery::extract_delivery_output_from_trigger_trace;
use super::delivery::extract_l1_to_l2_return_calls;
use super::delivery::MAX_SIMULATION_ITERATIONS;
