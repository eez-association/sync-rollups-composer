...
//!
//! Contains the core `simulate_l1_delivery` function and its helper functions,
//! shared between `l2_to_l1.rs` (single-call path) and `direction.rs`
//! (L2ToL1::enrich_calls_before_retrace). Also provides helpers used by
//! `simulate_l1_combined_delivery` in `l2_to_l1.rs`.

use alloy_primitives::{Address, U256};
use alloy_sol_types::SolCall;
use serde_json::Value;

use super::model::{L1ProxyLookup, ReturnEdge};
