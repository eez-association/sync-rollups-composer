...
use types::{
    CHECKPOINT_INTERVAL, FORK_CHOICE_DEPTH, L1ConfirmedAnchor, MAX_BACKOFF_SECS, MAX_BATCH_SIZE,
...
#[cfg(test)]
use types::{
    DESIRED_GAS_LIMIT, FCU_SYNCING_INITIAL_BACKOFF_MS, FCU_SYNCING_MAX_RETRIES, calc_gas_limit,
    compute_forkchoice_state, encode_block_transactions,
};
