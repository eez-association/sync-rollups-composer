...
| 3 | 3.7 | directions as thin adapters | dedicated | 🔄 in progress (3.7a proxy lookups ✅, 3.7b walk functions ✅, 3.7c all 3 local types → shared ✅; discovery loop + delivery sim migration remaining) | — |
