...
| 3 | 3.7 | directions as thin adapters | dedicated | 🔄 in progress (3.7a-d ✅: proxies, walks, types, both retrace bundles; discovery loop + delivery sim migration remaining for <800 LOC target) | — |
