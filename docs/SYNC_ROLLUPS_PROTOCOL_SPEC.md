...
This hash appears in both L2 Entry 0 and L2 Entry 2 (two entries share the same hash — the first one consumed is whichever is found first in the linear scan). The two entries have different `nextAction` fields.
...
*End of specification. This document covers the `feature/contract_updates` branch as of 2026-03-21. F.4 verified 2026-03-21.*
